...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin_auth'])->group(function () {
        ...
        Route::prefix('admin')->group(function () {
            ...
            Route::get('contact/showMessage', [ContactController::class, 'showMessage'])->name('admin#showMessage');
            ...
            Route::prefix('user')->group(function(){
                ...
                Route::get('delete', [UserController::class, 'deleteUser'])->name(('admin#deleteUser'));
                Route::get('modifyPage/{id}', [UserController::class, 'modifyUserPage'])->name('admin#modifyUserPage');
                Route::post('modifyUser/{id}', [UserController::class, 'modifyUser'])->name('admin#modifyUser');
            });

            //Change Admin to User (Ajax Method)
            Route::get('change/adminToUser', [AdminController::class, 'changeAdmintoUser'])->name('admin#ajaxChangeRole');

            Route::get('message/remove', [ContactController::class, 'removeSMS'])->name('admin#removeSMS');
        });
    });
    //Admim Category
    ...
    Route::group(['prefix' => 'user', 'middleware' => 'user_auth'], function () {
        ...
        Route::post('contact/sendMessage', [ContactController::class, 'sendMessage'])->name('user#sendMessage');
