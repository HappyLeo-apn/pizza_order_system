...
@section('content')
    ...
    <div class="container-fluid mt-3">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-4">
                <h5 class="section-title position-relative text-secondary text-uppercase mb-3"><span class=" pr-3">Cart
                        Summary</span></h5>
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <button id="orderBtn"
                            class="btn btn-block btn-primary text-light font-weight-bold my-3 py-3">Proceed To
                            Checkout</button>
                        <button id="clearBtn" class="btn btn-block btn-danger text-light font-weight-bold my-3 py-3">
                            Clear Cart
                        </button>
                    </div>
                </div>
